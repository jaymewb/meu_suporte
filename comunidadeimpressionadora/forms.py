...
class FormEditarPerfil(FlaskForm):
    ...
    curso_codigos = BooleanField('Codigos')
    curso_linguagem_de_front_end = BooleanField('linguagem de front-end')
    curso_linguagem_back_end = BooleanField('linguagem back-end')
...
class FormCriarPost(FlaskForm):
    titulo = StringField('Titulo do Post', validators=[DataRequired(), Length(2, 160)])
    corpo =TextAreaField('Escrever seu Post Aqui', validators=[DataRequired()])
